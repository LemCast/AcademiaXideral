...
public class SoldierRestController {
    ...
    // add mapping for GET /soldiers/{soldiersId}

    @GetMapping("/soldiers/{soldierId}")
    public com.luv2code.springboot.cruddemo.entity.Soldier getSoldier(@PathVariable int soldierId) {
    ...
    // add mapping for POST /soldiers - add new soldier
    ...
    // add mapping for PUT /soldiers - update existing soldier
    ...
    @PatchMapping("/soldier/{soldierId}")
    public com.luv2code.springboot.cruddemo.entity.Soldier patchSoldier(@PathVariable int soldierId,
    ...
    // add mapping for DELETE /soldiers/{soldierId} - delete soldier

    @DeleteMapping("/soldiers/{soldierId}")
    public String deleteSoldier(@PathVariable int soldierId) {
